...
class TrucksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create truck" do
    assert_difference('Truck.count') do
      post trucks_url, params: { truck: { description: @truck.description, logo: @truck.logo, name: @truck.name, tagline: @truck.tagline } }, as: :json
    end
  ...
  test "should update truck" do
    patch truck_url(@truck), params: { truck: { description: @truck.description, logo: @truck.logo, name: @truck.name, tagline: @truck.tagline } }, as: :json
    assert_response 200
  end
